...
Please review the [module documentation](https://pkg.go.dev/go.innotegrity.dev/async) for details on how to properly the functions and classes contained in this module.
...
If you have questions about this project, find a bug or wish to submit a feature request, please [submit an issue](https://github.com/innotegrity/go-async/issues).
